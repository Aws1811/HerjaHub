            ...
            <div class="profile-form">
                ...
                <form:form id="editProfileForm" action="${pageContext.request.contextPath}/customer/profile/edit" method="post" modelAttribute="editProfileForm">
                    ...
                    <div class="field-grid">
                        ...
                        <div>
                            <form:label path="currentPassword" cssClass="field-label">Current Password</form:label>
                            <form:password path="currentPassword" placeholder="Required to change password" cssClass="field-input" cssErrorClass="field-input field-error-input" />
                            <form:errors path="currentPassword" cssClass="field-error" element="span" />
                        </div>
