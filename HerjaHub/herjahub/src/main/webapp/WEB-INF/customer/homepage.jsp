                            ...
                            <div class="relative h-64 rounded-[28px] overflow-hidden shadow-lg mb-4 bg-secondary">
                                <c:choose>
                                    <c:when test="${not empty product.image}">
                                        <img src="${pageContext.request.contextPath}${product.image}" alt="${product.productName}" class="product-img w-full h-full object-cover transition-transform duration-300"/>
                                    </c:when>
                                    <c:otherwise>
