...
<title>Page Not Found — HerjaHub</title>
...
<div class="stage">
    <div class="error-card">
        <div class="error-icon"><i data-lucide="map-pin-off" width="34" height="34"></i></div>
        <p class="error-code">404</p>
        <h1 class="error-title">Page Not Found</h1>
        <p class="error-desc">The page you're looking for doesn't exist, may have been moved, or the link might be broken.</p>
