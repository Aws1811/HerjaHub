...
<title>Sign In Required — HerjaHub</title>
...
<div class="stage">
    <div class="error-card">
        <div class="error-icon"><i data-lucide="key-round" width="34" height="34"></i></div>
        <p class="error-code">401</p>
        <h1 class="error-title">Sign In Required</h1>
        <p class="error-desc">You need to be signed in to view this page. Your session may have expired.</p>
        <c:if test="${not empty path}">
            <span class="error-path">${path}</span>
        </c:if>
        <div class="error-actions">
            <button class="btn-secondary" onclick="history.back()"><i data-lucide="arrow-left" width="16" height="16"></i> Go Back</button>
            <a class="btn-primary" href="${pageContext.request.contextPath}/auth"><i data-lucide="log-in" width="16" height="16"></i> Log In</a>
        </div>
    </div>
</div>
